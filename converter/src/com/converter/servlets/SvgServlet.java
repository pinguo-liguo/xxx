...
import com.converter.svgFileOperations.SVGEdit;
...
public class SvgServlet extends HttpServlet {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2105635266152068998L;
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		PageLabel pageLabel = (PageLabel) springContext.getBean("pageLabel");
		BasicDataSource dataSource = (BasicDataSource) springContext
				.getBean("dataSource");

		String itemNr = pageLabel.getPartNo();
		String version = pageLabel.getPartAs();
		String initSide="00";
		//System.out.println(pageLabel.getChooseCs());
		//System.out.println(pageLabel.getChooseSs());
		
		if (pageLabel.getChooseCs()& pageLabel.getChooseSs()){
			initSide = "AB";			
		}else if(pageLabel.getChooseCs()){
			initSide = "CS";
		}else if (pageLabel.getChooseSs()){
			initSide = "SS";
		}
		
		//System.out.println(itemNr);
		//System.out.println(version);
		//System.out.println(pageLabel.getSide());
			...
			try {
				...
				if (svgDataBlob != null && svgStream !=null) {
					...
					svgEdit.writeEnhancedSVG_useStream(out, svgStream, itemNr,
							version, dataSource, absoluteURL,initSide);
